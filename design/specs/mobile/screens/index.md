...
| VideoCallActive | VideoCallActive | Full-screen video call | happy, error |
| VoiceCallOverlay | VoiceCallOverlay | Floating voice controls | happy, error |
| InvitationAcceptance | InvitationAcceptance | Accept invite deep link | happy, error |

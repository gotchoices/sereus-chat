# User Story: Voice and video call

## Story Overview

As a Sereus Chat user  
I want to Have a video conversation with someone I share a strand with  
So that I can have face-to-face communication when text messaging isn't sufficient.

Context: Susan and Bob have been chatting back and forth via text for a few minutes about a work project.
...
| Role | Who | Note |
|------|-----|------|
| Caller | Bob | places the call |
| Callee | Susan, Mike | accepts, declines, or is busy |
...
## Variants
- happy: a call placed and answered
- empty: n/a
- error: declined, busy, or too poor a connection to continue

## Open

Deferred by decision, kept as an objective. Likely built on a non-sereus library, and likely needs
at least one participant running a full-time cadre node. Group calling is a further question and is
not assumed. Not developed until the messaging stories are done.

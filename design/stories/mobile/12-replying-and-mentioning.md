...
Whether the set of reactions is fixed or open to any emoji is undecided, and is a smaller question
than it looks: an open set means an arbitrary string on a message, which is a message by another
name.
